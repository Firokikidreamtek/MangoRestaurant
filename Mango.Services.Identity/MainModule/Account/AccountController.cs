    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                else return this.LoadingPage("Redirect", model.ReturnUrl);
            }
            else
            {
                ModelState.AddModelError("Password", "Пароль должен содержать как минимум 1 заглавную букву 1 цифру и 1 спец символ");
            }
